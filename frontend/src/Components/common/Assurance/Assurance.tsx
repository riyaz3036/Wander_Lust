...
const Assurance=()=>{
    ...
    <div className="flex justify-center items-center py-20 flex-wrap assurance_main">
        <div className="assurance_section">
            <div className="flex justify-center text-3xl pb-7 assurance_logo"><i className="ri-plane-fill"></i></div>
        ...
        <div className="assurance_section">
            <div className="flex justify-center text-3xl pb-7 assurance_logo"><i className="ri-lock-fill"></i></div>
        ...
        <div className="assurance_section">
            <div className="flex justify-center text-3xl pb-7 assurance_logo"><i className="ri-customer-service-2-fill"></i></div>
